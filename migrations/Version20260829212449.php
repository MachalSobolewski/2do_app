 ...
 */
final class Version20260829212449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE board_column ADD board_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE task ADD board_column_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_527EDB25CA372FE ON task');
        $this->addSql('ALTER TABLE task DROP board_column_id');
    }
}
